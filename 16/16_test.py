...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            "16/test_input_1.txt", 7036, id="Day 16 Part 1 - Test Input",
        ),
        pytest.param(
            "16/test_input_2.txt", 11048, id="Day 16 Part 1 - Test Input",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            "16/test_input_1.txt", 45, id="Day 16 Part 1 - Test Input",
        ),
        pytest.param(
            "16/test_input_2.txt", 64, id="Day 16 Part 1 - Test Input",
        ),
    ],
)
