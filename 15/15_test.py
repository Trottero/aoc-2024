...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            "15/test_input_1.txt", 2028, id="Day 15 Part 1 - Test Input",
        ),
        pytest.param(
            "15/test_input_2.txt", 10092, id="Day 15 Part 1 - Test Input",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            "15/test_input_3.txt", 618, id="Day 15 Part 2 - Test Input",
        ),
        pytest.param(
            "15/test_input_2.txt", 9021, id="Day 15 Part 2 - Test Input",
        ),
    ],
)
